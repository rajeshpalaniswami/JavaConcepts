...
public class IfClassO10 {
	...
	public static void main(String[] args) {
		...
		if(number >100) {
			System.out.println("Yes the given number is greater than 100 and the number is >>>"+number);
		}else {
			System.out.println("No the given number is greater than 100 and the number is >>>"+number);
		}
